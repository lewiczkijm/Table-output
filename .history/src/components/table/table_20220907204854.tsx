...
const headerFormatter = (column: any, colIndex: any, components: any) => {
  ...
  let params = { svgStyle: {}, arrowStyle: {}, funnelStyle: {} };

  switch (components.sortElement.props.order) {
    case "asc":
      params = { svgStyle: { transform: "rotate(180deg)" }, arrowStyle: {}, funnelStyle: {} };
      break;
    case "desc":
      params = { svgStyle: {}, arrowStyle: {}, funnelStyle: {} };
      break;
    case undefined:
      params = { svgStyle: {}, arrowStyle: { display: "none" }, funnelStyle: {} };
      break;
  }
    ...
    <>
      ...
      <svg style={params.svgStyle} width="14" height="10" viewBox="0 0 14 10" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          ...
          fill="#82868C"
        />
        <path style={params.funnelStyle} d="M0 1V0H7V1H0ZM0 3V2H6V3H0ZM0 5V4H5V5H0ZM0 7V6H4V7H0ZM0 9V8H3V9H0Z" fill="#82868C" />
      </svg>
    </>
  );
};
